...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // Update status enum - this is tricky with existing column
    try {
      ...
      if (!existingValues.includes('pending_cancellation')) {
        // PostgreSQL doesn't allow direct enum modification, need to recreate
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    // Note: Removing enum values is complex in PostgreSQL, usually not done
