...
class QrController {
  // Validation rules for QR creation
  ...
  // Create QR code with quota checking
  ...
  // Get user's QR codes with filters
  ...
  async trackScan(req, res) {
    try {
      ...
      const scanData = {
        ...
        locationData: req.body.locationData // Optional geolocation data from client
      };
